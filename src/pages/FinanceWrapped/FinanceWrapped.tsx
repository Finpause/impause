...
export default function FinanceWrapped() {
  ...
  const handleFileUpload = async (files: FileList | null) => {
    ...
    try {
      ...
      const analysis = await uploadBankStatements(fileArray)

      // Transform the data for each timeframe
      const weeklyTransformed = transformAnalysisToWrappedData(analysis, "weekly")
      const monthlyTransformed = transformAnalysisToWrappedData(analysis, "monthly")
      const yearlyTransformed = transformAnalysisToWrappedData(analysis, "yearly")
